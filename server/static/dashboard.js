...
/***/ function(module, exports, __webpack_require__) {
	...
	var postCondition = function postCondition(condition) {
	  return function (dispatch) {
	    ...
	    fetch('/api/conditions', {
	      ...
	      dispatch({
	        type: _ConditionsReducer.conditionsConstants.ADD_CONDITION,
	...
	var deleteCondition = function deleteCondition(diff) {
	  return function (dispatch) {
	    fetch('/api/conditions/' + diff, {
	      ...
	      dispatch({
	        type: _ConditionsReducer.conditionsConstants.DELETE_CONDITION,
	        payload: json.diff
	      });
	    })['catch'](function (error) {
	...
	var store = (0, _redux.createStore)(reducers, (0, _redux.applyMiddleware)(_reduxThunk2['default'], serverApiMiddleware));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objectAssign = __webpack_require__(235);
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                ...
	                React.createElement(
	                  ...
	                  React.createElement(
	                    'a',
	                    { href: '#', onClick: this.onOffClick.bind(this) },
...
/***/ function(module, exports) {
	...
	var homeConstants = exports.homeConstants = function homeConstants() {
	  _classCallCheck(this, homeConstants);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Conditions = function (_Component) {
	  ...
	  function Conditions() {
	    ...
	    return _possibleConstructorReturn(this, (Conditions.__proto__ || Object.getPrototypeOf(Conditions)).apply(this, arguments));
	  }
	
	  _createClass(Conditions, [{
	    key: 'changeDiff',
	    value: function changeDiff(e) {
	      e.preventDefault();
	      this.props.setDiff(e.target.value);
	    }
	  }, {
	    key: 'changeLots',
	    value: function changeLots(e) {
	      e.preventDefault();
	      this.props.setLots(e.target.value);
	    }
	  }, {
	    key: 'changeProfit',
	    value: function changeProfit(e) {
	      e.preventDefault();
	      this.props.setProfit(e.target.value);
	    }
	  }, {
	    key: 'clickAdd',
	    value: function clickAdd(e) {
	      e.preventDefault();
	      var _props$state = this.props.state,
	          editDiff = _props$state.editDiff,
	          editLots = _props$state.editLots,
	          editProfit = _props$state.editProfit;
	
	      this.props.requestAddCondition(parseInt(editDiff), parseFloat(editLots), parseFloat(editProfit));
	    }
	  }, {
	    key: 'clickDelete',
	    value: function clickDelete(e) {
	      e.preventDefault();
	      var editDiff = this.props.state.editDiff;
	
	      this.props.requestDeleteCondition(parseInt(editDiff));
	    }
	  }, {
	    key: 'clickCondition',
	    value: function clickCondition(_ref, e) {
	      var diff = _ref.diff,
	          lots = _ref.lots,
	          profit = _ref.profit;
	    ...
	    value: function render() {
	      ...
	      console.log('this', this);
	      var listConditions = state.conditions.map(function (condition, i) {
	        return React.createElement(
	          'tr',
	          { key: i, className: 'row',
	            onClick: _this2.clickCondition.bind(_this2, condition) },
	          React.createElement(
	            'td',
	            null,
	            condition.diff
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'label',
	                { htmlFor: 'input-condition-diff' },
	                'Prices diff.'
	              ),
	              React.createElement('input', { type: 'text', onChange: this.changeDiff.bind(this),
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'label',
	                { htmlFor: 'input-condition-lots' },
	                'Order lot'
	              ),
	              React.createElement('input', { type: 'text', onChange: this.changeLots.bind(this),
	            ...
	            React.createElement(
	              ...
	              React.createElement(
	                'label',
	                { htmlFor: 'input-condition-profit' },
	                'Closing profit'
	              ),
	              React.createElement('input', { type: 'text', onChange: this.changeProfit.bind(this),
	          ...
	          React.createElement(
	            'button',
	            { onClick: this.clickAdd.bind(this), className: 'button-primary' },
	            'Add/Update'
	          ),
	          ' ',
	          React.createElement(
	...
	exports['default'] = (0, _reactRedux.connect)(mapStateToProps, {
	  setDiff: function setDiff(diff) {
	    return {
	      type: _ConditionsReducer.conditionsConstants.SET_DIFF,
	      payload: diff
	    };
	  },
	  setLots: function setLots(lots) {
	    return {
	      type: _ConditionsReducer.conditionsConstants.SET_LOTS,
	      payload: lots
	    };
	  },
	  setProfit: function setProfit(profit) {
	    return {
	      type: _ConditionsReducer.conditionsConstants.SET_PROFIT,
	      payload: profit
	    };
	  },
	  ...
	  deleteCondition: function deleteCondition(diff) {
	    return {
	      type: _ConditionsReducer.conditionsConstants.DELETE_CONDITION,
	      payload: diff
	    };
	  },
	  requestAddCondition: function requestAddCondition(diff, lots, profit) {
	    return {
	      type: _ConditionsReducer.conditionsConstants.REQUEST_ADD_CONDITION,
	      payload: { diff: diff, lots: lots, profit: profit }
	    };
	  },
	  requestDeleteCondition: function requestDeleteCondition(diff) {
	    return {
	      type: _ConditionsReducer.conditionsConstants.REQUEST_DELETE_CONDITION,
	      payload: diff
	    };
	  }
	})(Conditions);
...
/***/ function(module, exports) {
	...
	var conditionsConstants = exports.conditionsConstants = function conditionsConstants() {
	  _classCallCheck(this, conditionsConstants);
	};
	
	conditionsConstants.SET_CONDITIONS = 'CONDITIONS_SET_CONDITIONS';
	conditionsConstants.SET_DIFF = 'CONDITION_SET_DIFF';
	conditionsConstants.SET_LOTS = 'CONDITION_SET_LOTS';
	conditionsConstants.SET_PROFIT = 'CONDITION_SET_PROFIT';
	conditionsConstants.ADD_CONDITION = 'CONDTION_ADD_CONDITION';
	...
	function conditionsReducer() {
	  ...
	  if (type == conditionsConstants.SET_CONDITIONS) {
	    ...
	    var _conditions = state.conditions.concat();
	    var idx = _conditions.findIndex(function (e, i) {
	      return e.diff == payload.diff;
	    });
	    if (idx >= 0) {
	      _conditions[idx] = payload;
	    } else {
	      _conditions.push(payload);
	      _conditions.sort(function (a, b) {
	    ...
	    var _ret = function () {
	      var conditions = state.conditions.concat();
	      var diff = payload;
	      return {
	        v: Object.assign({}, state, {
	          conditions: conditions.filter(function (e, i) {
	            return e.diff != diff;
	          })
	        })
	      };
	...
	var Ticks = function (_Component) {
	  ...
	  _createClass(Ticks, [{
	    ...
	    value: function render() {
	      ...
	      console.log('this', this);
	      var listExchangers = Object.keys(state.exchangers).map(function (name, i) {
	        return React.createElement(
	          'tr',
	          { key: i, className: 'row' },
	          React.createElement(
	          ...
	          React.createElement(
	            'td',
	            null,
	            state.exchangers[name].ask
	          ),
	          React.createElement(
	            'td',
	            null,
	            state.exchangers[name].bid
	          ),
	          React.createElement(
	            'td',
	            null,
	            state.exchangers[name].datetime
	          )
	        );
	      });
	      return React.createElement(
...
/***/ function(module, exports) {
	...
	exports.ticksReducer = ticksReducer;
	
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
	
	var ticksConstants = exports.ticksConstants = function ticksConstants() {
	  _classCallCheck(this, ticksConstants);
	};
